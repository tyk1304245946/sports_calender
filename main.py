...
if __name__ == "__main__":
    ...
    parser.add_argument("--app_id", type=str, required=True, help="Feishu App ID")
    parser.add_argument("--app_secret", type=str, required=True, help="Feishu App Secret")
    args = parser.parse_args()
    main(args.app_id, args.app_secret)